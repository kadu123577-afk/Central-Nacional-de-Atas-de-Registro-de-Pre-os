  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-12">
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-neutral-700">
        <section>
          <h2 className="text-base font-semibold text-neutral-900">1. O que é a plataforma</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-semibold text-neutral-900">2. O papel da plataforma</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-semibold text-neutral-900">3. Cadastro e uso gratuito</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-semibold text-neutral-900">4. Cobrança da taxa de intermediação</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-semibold text-neutral-900">5. Responsabilidade do usuário</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-semibold text-neutral-900">6. Contato</h2>
